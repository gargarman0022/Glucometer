...
<nav class="navbar navbar-expand-lg bg-primary">
    ...
    <br>
    <div class="bdy">
    <h2>What physical activities have you done today?</h2><br>
    <form action="emotions_ba.php" method="post">
    ...
    <div class="emoji-box" id="sad" onclick="selectEmoji('sad')"><div class="emoji"><img src="images/exercise.jpg"></div> <div class="txt">Exercise</div>
    ...
    <div class="emoji-box" id="angry" onclick="selectEmoji('angry')"><div class="emoji"><img src="images/Cycling.jpg"></div> <div class="txt">Cycling</div>
    ...
    <div class="emoji-box" id="cool" onclick="selectEmoji('cool')"><div class="emoji"><img src="images/playing.jpg"></div> <div class="txt">Playing</div>
    <label for="hours_4"><b>Hours:&nbsp;&nbsp;&nbsp;</b></label>
    <select name="hours_4" id="hours">
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <select name="minutes_4" id="minutes">
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <div class="emoji-box" id="sleepy" onclick="selectEmoji('sleepy')"><div class="emoji"><img src="images/hiking.jpg"></div> <div class="txt">Hiking</div>
    <label for="hours_5"><b>Hours:&nbsp;&nbsp;&nbsp;</b></label>
    <select name="hours_5" id="hours">
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <select name="minutes_5" id="minutes">
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <div class="emoji-box" id="others" onclick="selectEmoji('others')"><div class="emoji"><img src="images/others.jpeg"></div> <div class="txt">Others</div>
    <label for="hours_6"><b>Hours:&nbsp;&nbsp;&nbsp;</b></label>
    <select name="hours_6" id="hours">
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <select name="minutes_6" id="minutes">
        <option value="0">0</option>
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
    ...
    <!-- <h2>Total time you spent on physical activities:</h2><br> -->
    <!-- <form id="time-form"> -->
        <!-- <label for="hours_7"><b>Hours:&nbsp;&nbsp;&nbsp;</b></label>
        <select name="hours_7" id="hours">
            <option value="0">0</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
        ...
        <select name="minutes_7" id="minutes">
            <option value="0">0</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
    ...
    <!-- </form> -->
    <br><input type="submit" value="Submit" class="btn btn-success button">
</form>
</div>
    ...
    <script>
                    ...
                    // if(emoji!='angry'){
                        ...
                        // if(emoji!='cool'){
                            ...
                            // if(emoji!='sleepy'){
                                ...
                                // }
                                // if(emoji!='others'){
                                    //     document.getElementById('others').style.border = "";
            // }
        ...
        function myfunc(){
            ...
            //     $sql = 'INSERT INTO activities(Nam,id,activity,dat,tim,grpid) VALUES ("sonoo", 9000,"iodjifdh","12-12-2012","12:30",38775)';  
            ...
            // ?>  
            window.location.href='stressrelivingactivities.html';
        }
    </script>
